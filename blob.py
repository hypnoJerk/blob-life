...
def proximity_sensor_intit():
    global humidity_baseline, humidity, proximity_delay_tick, \
        sum_humidity
...
def proximity_calc():
    global clock_tick, humidity_baseline, humidity, sum_humidity, \
        proximity_delay_tick, proximity_detected, color, scared
...
def main_ai_loop():
    global scared, sleeping, proximity, walk_frequency, proximity, \
        color, detect_movement, hunting
